...
const App = () => {
    ...
    //     setMessage([{message: newMessage},...messages])
    // }
    const setCurrentNewMessage = (currentNewMessage: string) => {
        setCurrentMessage(currentNewMessage);
    }
    const onClickButtonHandler = () => {
        setMessage([{message: currentMessage}, ...messages])
        setCurrentMessage("")
    }

    return (
        <div className={"App"}>
            {/*<InputWithButton setNewMessage={setNewMessage}/>*/}
            <Input setCurrentNewMessage={setCurrentNewMessage} currentMessage={currentMessage}/>
            <Button name="+" onClickButtonHandler={onClickButtonHandler}/>
